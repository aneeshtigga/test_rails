  ...
  describe "GET /api/v1/filter_data" do
    ...
    describe "Location Data" do
      it "returns location filter data" do
        ...
        token_encoded_get("/api/v1/filter_data", params: params, token: @token)
      ...
      describe "gender_identity" do 
        it "returns gender_identity" do 
          token_encoded_get("/api/v1/filter_data", params: {}, token: @token)
      ...
      describe "Marketing Referrals Data" do
        it "returns the possible marketing referrals" do
          ...
          token_encoded_get("/api/v1/filter_data", token: @token)
