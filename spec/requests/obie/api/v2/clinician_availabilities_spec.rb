...
RSpec.describe "V2 ClinicianAvailabilities", type: :request do
  ...
  describe " GET /obie/api/v2/clinician_availabilities " do
    ...
    it "responds with 401 for requests without authorization headers" do
      token_encoded_get("/obie/api/v2/clinician_availabilities", params: {}, token: nil)

      expect(response).to have_http_status(:unauthorized)
    end

    it "responds with clinician availability" do
      token_encoded_get("/obie/api/v2/clinician_availabilities",
