...
RSpec.describe "AccountHolders", type: :request do
  ...
  describe "PUT send confirmation email" do
    ...
    it "returns an error object when id does not exist" do
      ...
      token_encoded_put("/abie/api/v2/account_holders/999999/send_confirmation_email", params: params, token: @token)
    ...
    context "with a valid id" do
      before do
        Sidekiq::Testing.inline! do
          ...
          token_encoded_put(
            "/abie/api/v2/account_holders/#{account_holder.id}/send_confirmation_email",
