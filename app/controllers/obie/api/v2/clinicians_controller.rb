# app/controllers/obie/api/v2/clinicians_controller.rb
  ...
  module Api
    module V2
      class CliniciansController < ApplicationController
        ...
        def index
          clinicians = Obie::V2::CliniciansSearchBuilder.build(permitted_search_params)
          meta = {
        ...
        def validate_required_params
          ...
          raise 'Missing required params' if missing_params.present?
        rescue StandardError => e
          ErrorLogger.report(e)
