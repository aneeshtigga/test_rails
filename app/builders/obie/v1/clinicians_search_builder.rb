module Obie
  module V1
    class CliniciansSearchBuilder < Obie::CliniciansSearchBuilder
      private
      ...
      def build_serialized_clinician_list(params)
        ...
        ActiveModelSerializers::SerializableResource.new(
          @results.includes(
            :insurances,
            clinician: %i[
              languages interventions populations expertises
              concerns type_of_cares license_types
            ]
          ),
          all_clinician_availabilities: all_clinician_availabilities,
          each_serializer:      Obie::V1::ClinicianSearchSerializer,
